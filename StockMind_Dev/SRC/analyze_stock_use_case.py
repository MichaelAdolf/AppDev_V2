...
from stockmind.application.history.historical_evidence_service import (
    ...
    def execute(
        ...
        historical_evidence = (
            ...
            .build(
                ...
                setup_result=historical_result,
                analysis_period="5y",
                max_gap_days=3
            )
        )
        confidence_result = (
            ...
            .calculate(
                rule_results=rule_results,
                historical_success_result=historical_evidence
            )
        )
        ...
        explanation_result = (
            ...
            .create(
                ...
                quality_result=quality_result,
                confidence_result=confidence_result,
                historical_result=historical_evidence,
                risk_result=risk_result,
        ...
        AnalysisHistoryRepository().save(
            AnalysisHistoryEntry(
                ...
                historical_success_rate=(
                    historical_evidence.success_rate
                ),
