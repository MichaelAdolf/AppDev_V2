...
final Color color; final double progress; final bool speaking;

_VoiceRingPainter({ required this.color, required this.progress, required this.speaking, });
...
@override bool shouldRepaint( covariant _VoiceRingPainter oldDelegate) => true; }
...
/*
//Gut aber buggy, vielleicht ist die Folgeversion besser
class _VoiceRingPainter
    extends CustomPainter {
