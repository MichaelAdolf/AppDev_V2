...
import '../../../services/jarvis_external_trigger_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late final JarvisExternalTriggerService _externalTriggerService;
  ...
  void initState() {
    ...
    _externalTriggerService = JarvisExternalTriggerService (
      websocketUrl: NodeRedConfig.websocketUrl,
      onResponse: (response) {
        controller.handleExternalResponse(
          response,
          source: 'node-red',
        );
      },
      onStatusChanged: (message){
        debugPrint('[Jarvis WebSocket] $message');
      },
    );
    _externalTriggerService.connect();
  }

  @override
  void dispose() {
    _externalTriggerService.dispose();
